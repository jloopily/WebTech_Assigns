                    ...
                    <div class="panel-body">
                        <form role="form" action="editdo.php" method='post'>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="form-control" placeholder="班级" name='className'
                                    value="<?= $row['className'] ?>" />
                            </div>
                            ...
                            <div class="form-group input-group">
                                ...
                                <div align='left'>&nbsp;&nbsp;
                                    <input type="radio" placeholder="性别" name='sex' value='男'
                                        <?= $row['sex'] == '男' ? 'checked' : '' ?> />男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" placeholder="性别" name='sex' value='女'
                                        <?= $row['sex'] == '女' ? 'checked' : '' ?> />女
                                </div>
                            </div>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="form-control" placeholder="民族" name='nation'
                                    value="<?= $row['nation'] ?>" />
                            </div>
